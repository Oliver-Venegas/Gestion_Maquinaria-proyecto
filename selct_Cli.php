    ...
    <a class="cerr_sess" href="index.html" style="--i:4;">Cerrar Sesion</a>
        ...
        <div class="row align-items-stretch">
            ...
            <div class="col p-5 bg-white mt-5 rounded shadow">
                    ...
                    <div class="row">
                    <div class="col p-2">
                  <a class="btn_backlog btn btn-light btn-lg" href="view_Client.php">Mostrar Clientes</a>
                   </div>

                   <div class="col p-2">
                   <a class="btn_backlog btn btn-light btn-lg" href="creat_Client.php">Crear Clientes</a>
